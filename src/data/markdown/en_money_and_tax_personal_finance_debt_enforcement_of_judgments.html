...
and-tax/personal-finance/debt/) > Enforcement of debt judgments
...
If you owe money to someone else, then you are a **debtor** and the other
person is a **creditor** .

If you fail to pay a debt, your creditor can go to court to get a **judgment**
that you owe the debt. If your creditor has a judgment, it means they can now
use different ways to get the money from you. This is called **enforcing** **a
judgment** . The legal term is **execution** of the judgment.

The creditor chooses how to enforce the judgment, and can use several
different types of enforcement action at the same time. We explain these
below.

##  What happens when the creditor has a judgment order?

When the creditor has a judgment order from a court, the judgment can be
enforced through an enforcement order. Enforcement orders can be issued by
court offices – the creditor does not have to go back to court for the order.

Creditors have 12 years from the date of the judgment order to look for
enforcement orders. Enforcement orders are usually valid for one year and can
then be renewed.

If more than 6 years have passed since the judgment order was issued, **a
Leave of the court** (the court’s permission) is needed to continue.

###  What is a stay of execution?

When a court pauses an enforcement for a period of time, it is known as **stay
of execution** .

A stay of execution may be granted, for example, if you can show that it is
not your fault that you are unable to pay.

You cannot get a stay of execution if you have not been engaging with the
court process.

###  What does registration of the judgment mean?

By registering the judgment, the creditor makes it public that there is a
judgment against you for not paying money you owe. Registering the judgment
does not directly enforce the judgment.

When it is made public, you are unlikely to be able to borrow more money. The
creditor must tell you they plan to register the judgment before they register
it. This gives you a chance to pay the debt.

The creditor can register the court judgment in the Central Office of the High
Court. Credit reference agencies publish lists of judgments that are consulted
by banks (for example, in _Stubbs Gazette_ and some newspapers).

###  Main ways a creditor can enforce a judgment

There are 4 main ways a creditor can enforce a judgment which we explain
below:

  * Execution against goods 
  * Instalment orders, followed by committal orders (if necessary) 
  * Attachment of earnings 
  * Judgment mortgage (see more [ about home repossession ](/en/housing/losing-your-home-and-homelessness/home-repossession/) ) 

Other ways of enforcing judgments include attachment of debts, appointment of
a receiver and bankruptcy proceedings. These are rarely used for consumer
debts. They are briefly explained in ‘Other methods of enforcing judgments’
below.

##  Execution against goods

Execution against goods means that the creditor gets an order from the court
which directs the Sheriff or County Registrar to seize your goods. The goods
are sold and the money raised used to pay the unpaid debt.

This one of the main ways a creditor can enforce a judgment. It is sometimes
called **distress** against goods. Execution against goods can have different
...
The creditor can apply to court to have your financial circumstances examined
to see what available assets you have that can be used to carry out the
judgment.
...
By law, the Sheriff or County Registrar cannot seize certain goods. They
cannot take your necessary clothes and bedding and the tools of your trade, if
the total value of such items is less than €19. In practice, goods with a low
resale value are unlikely to be seized. They are likely to take electrical
items, jewellery or your car (if you do not need it for work).
...
If you do not turn up, without a reasonable excuse, the judge can either
adjourn the hearing or issue an arrest warrant. An arrest warrant orders the
Gardaí to bring you before the court as soon as possible.

If you are later arrested and brought to court, a date is fixed for the
hearing. The judge must make clear to you, in ordinary language:
...
The court has the power to grant you legal aid in line with the rules
governing the [ criminal legal aid scheme ](/en/justice/legal-aid-and-
advice/criminal-legal-aid/) .

##  Attachment of earnings

This is when the money you owe is deducted straight from your wages by direct
debit. The creditor seeks an order from court which is then served on the
debtor’s employer, who sets up a direct debit.

Attachment of earnings is currently only used for [ orders of maintenance of
spouses and children ](/en/birth-family-relationships/separation-and-
...
The creditor may register a charge against property owned by you. The effect
is the same as taking out a mortgage. You have to pay off the judgment
mortgage when the property is sold. Read more [ about home repossession
](/en/housing/losing-your-home-and-homelessness/home-repossession/) .

###  Attachment of a debt, or _garnishee order_

If you owe money to a creditor and another person owes money to you, then your
creditor can get a court order directing that person to pay the money directly
to the creditor. This is known as a _garnishee order_ .

Generally, it is used only where there are no goods to be seized to be offset
against the judgment. It is relatively rarely used in cases of consumer debt.
[ Revenue has specific powers of attachment
](https://www.citizensinformation.ie/en/money-and-tax/personal-
finance/debt/specific-debts/#7e36e37e36e3) which can be exercised without a
court order.

###  Appointment of a receiver

A receiver may be appointed over some of your assets or over future income
such as rents, income of a trust fund or a pension. The law in this area is
complex, but it seems that a receiver cannot be appointed over future
earnings.

###  Bankruptcy

If you are unable to pay your debts, you can apply to the High Court to be
declared bankrupt. Alternatively, your creditor may apply to have you declared
bankrupt if certain conditions are met. [ Read more about bankruptcy
](/en/money-and-tax/personal-finance/debt/personal-insolvency/what-is-
bankruptcy/) .
...
and-tax/personal-finance/debt/enforcement-of-debt-
judgments/?utm_source=sharebutton_facebook) [
](https://twitter.com/intent/tweet/?text=Enforcement%20of%20debt%20judgments&url=https://www.citizensinformation.ie/en/money-
and-tax/personal-finance/debt/enforcement-of-debt-
judgments/?utm_source=sharebutton_twitter) [
](whatsapp://send?text=https://www.citizensinformation.ie/en/money-and-
tax/personal-finance/debt/enforcement-of-debt-
judgments/?utm_source=sharebutton_whatsapp) [
](mailto:?subject=Enforcement%20of%20debt%20judgments&body=https://www.citizensinformation.ie/en/money-
and-tax/personal-finance/debt/enforcement-of-debt-
judgments/?utm_source=sharebutton_email) [ ](javascript:void\(0\))
...
1101.577
  ...
  * [ _Overview of mortgage debt_ ](/en/housing/owning-a-home/mortgage-arrears/overview-of-mortgage-debt/)

Information for people facing mortgage arrears.

1085.8774

  * [ _Overview of employment rights enforcement_ ](/en/employment/enforcement-and-redress/enforcing-your-employment-rights/)
